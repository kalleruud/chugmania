...
--> statement-breakpoint
INSERT INTO `__new_matches`("id", "updated_at", "created_at", "deleted_at", "user_a", "user_b", "winner", "track", "session", "status", "duration_ms", "comment") SELECT "id", "updated_at", "created_at", "deleted_at", "user_a", "user_b", "winner", "track", "session", "status", "duration_ms", "comment" FROM `matches`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_tournament_matches`("id", "updated_at", "created_at", "deleted_at", "match", "stage", "index") SELECT "id", "updated_at", "created_at", "deleted_at", "match", "stage", "index" FROM `tournament_matches`;--> statement-breakpoint
