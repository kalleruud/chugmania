...
--> statement-breakpoint
INSERT INTO `__new_matches`("id", "updated_at", "created_at", "deleted_at", "user_a", "user_b", "winner", "track", "session", "status", "duration_ms", "completed_at", "comment", "index", "stage") SELECT "id", "updated_at", "created_at", "deleted_at", "user1", "user2", "winner", "track", "session", "status", "duration_ms", NULL, "comment", NULL, NULL FROM `matches`;--> statement-breakpoint
