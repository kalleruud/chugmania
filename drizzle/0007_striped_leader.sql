...
CREATE TABLE `tournament_matches` (
	...
	FOREIGN KEY (`source_group_a`) REFERENCES `groups`(`id`) ON UPDATE no action ON DELETE set null,
	FOREIGN KEY (`source_group_b`) REFERENCES `groups`(`id`) ON UPDATE no action ON DELETE set null,
	FOREIGN KEY (`source_match_a`) REFERENCES `tournament_matches`(`id`) ON UPDATE no action ON DELETE set null,
	FOREIGN KEY (`source_match_b`) REFERENCES `tournament_matches`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
